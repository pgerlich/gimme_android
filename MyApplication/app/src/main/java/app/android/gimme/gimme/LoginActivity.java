...
/**
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        super.onActivityResult(requestCode, resultCode, data);clear
    ...
    private void registerClicked(View view){
        Intent registerPageIntent = new Intent(getApplicationContext(),RegisterPageActivity.class);
    ...
    // Retrieve information for user before proceeding to home screen
